...
class GeneralizedElasticNetRegressorTTT(BaseEstimator, RegressorMixin):
    """

    """

    def __init__(self, beta, target_number, lam_2=0.0, lowbo=None, upbo=None, ds=None, sigma_ds=None, wvec=None,
                 random_state=None,
