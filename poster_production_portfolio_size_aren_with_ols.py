...
log('poster_experiments_portfolio_size_aren_ols.txt',
...
for update_frequency in \
    ...
    for portfolio_size in [25, 45, 65, 85]:
        ...
        for i in range(nps):
            ...
            print('check number of non zero coefs: {}'.format(np.sum(coef > zero_threshold)))
        ...
        temp_results_return.append(pred)
        temp_results_coefs.append(coefs.T)
        ...
        log('poster_experiments_portfolio_size_aren_ols.txt', '{set0}, {set2}, {set3}, {set4}, {set5}, {num0:.2%},{num1:.2%},{num2:.2%},'
            '{num3:.3%},{num4:.3%},{num5:.2%},{num6: .2e}'
            .format(set0=update_frequency,
                    set2=portfolio_size,
                    set3=training_month,
    ...
    results_return.append(temp_results_return)
    results_coefs.append(temp_results_return)
...
np.save('AREN_OLS_portfolio_size_returns', results_return)
np.save('AREN_OLS_portfolio_size_coefs', results_coefs)
np.save('AREN_OLS_portfolio_size_dates', dates)
