...
study_name = 'buy-and-hold-study-arls-vs-argen_2'  # Unique identifier of the study.
...
if __name__ == '__main__':
    study.optimize(lambda trial: objective(trial, p_, X_train_, y_train, X_test_, y_test, lowbo, upbo), n_trials=10000,
                   n_jobs=6)
