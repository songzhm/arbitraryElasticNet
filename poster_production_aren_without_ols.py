...
log('poster_experiments_aren_no_ols.txt',
...
for update_frequency in \
    ...
    log('poster_experiments_aren_no_ols.txt', '{set0}, {set2}, {set3}, {set4}, {set5}, {num0:.2%},{num1:.2%},{num2:.2%},'
        '{num3:.3%},{num4:.3%},{num5:.2%},{num6: .2e}'
        .format(set0=update_frequency,
                set2=portfolio_size,
                set3=training_month,
...
np.save('AREN_NO_OLS_returns', results_return)
np.save('AREN_NO_OLS_coefs', results_coefs)
np.save('AREN_NO_OLS_dates', dates)
