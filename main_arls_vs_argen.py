...
study_name = 'buy-and-hold-study-arls-vs-argen_40_B_0.6_1_fold'  # Unique identifier of the study.
...
def trial_log_callback(benchmark_score, study, trial):
    if trial.value < 0.8*benchmark_score:
